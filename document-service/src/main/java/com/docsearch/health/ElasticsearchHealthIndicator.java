...
/**
 * Surfaces Elasticsearch cluster health under GET /actuator/health so an
 * orchestrator (or a human during the demo) can see dependency status
 * without cross-referencing a separate dashboard. Postgres, Redis and Kafka
 * health are covered by Spring Boot's own auto-configured indicators.
 */
@Component
